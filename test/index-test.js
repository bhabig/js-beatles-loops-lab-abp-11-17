describe('Beatles Loops', function() {
  it("returns an array of strings containing what instruments each musician plays", function() {
    ...
    expect().toEqual(["John Lennon plays Guitar", "Paul McCartney plays Bass Guitar", "George theBeatlesPlay(musicians, instruments)Harrison plays Lead Guitar", "Ringo Starr plays Drums"]);
  });
